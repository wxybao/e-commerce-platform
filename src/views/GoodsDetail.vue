            ...
            <div class="collapse-text-box-bg">
              <div v-if="item.name === '1'">
                ...
                <div class="collapse-text-box-desc font-bold">90cc двухтактный двигатель, обеспечивающий 2.5 лошадиные
                  силы и
                  способный развивать максимальную скорость до 45 км/ч. Вы можете настроить его, установив ваш
              ...
              <div v-if="item.name === '3'">
                ...
                <div class="collapse-text-box-desc">
                  ...
                  Именно поэтому наши картинги отличаются инновационным дизайном и прочными материалами, что
                  гарантирует, что, независимо от того, что вас ждет впереди, вы будете уверенно справляться с любыми
                  препятствиями. Независимо от того, пересекаете ли вы леса или исследуете дикую природу, наши картинги
                  обеспечивают неповторимое удовольствие от вождения.
                </div>
                <div class="collapse-text-box-img"></div>
                <div class="collapse-text-box-desc">
                ...
                <div class="collapse-text-box-desc">
                  ...
                  надеемся, что вы найдете ту свободу и волнение, которых жаждете, с нашими картингами. Присоединяйтесь
                  к нам в бесстрашном путешествии и начните свою собственную легенду приключений.
                </div>
              </div>
